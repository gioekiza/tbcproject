#ინსტანსების შექმნა და საშირო პორტების გახსნა
...
#ელასტიკ ip ის შექმნა
resource "aws_eip" "eip" {
  instance = aws_instance.active.id
}

#ლამბდა ფაილოვერ როლის შექმნა
...
#ფეილოვერის ზიპ ფაილის შექმნა რომელსაც გადაყავს გათიშვის შემთხვევაში აქტიურიდან პასუირზე 
...
#SNS ის შექმნა რომ გამოიძახოს ლამბდა
...
#cloudwatch შექმნა რომელიც გამოიძახებს SNS-ს
...
#s3_bucket თვის წვდომის განსაზღვრა
...
#s3_bucket ში სურათის ატვირთვა და ქეშირების კონფიგურაცია
...
#რედაქტირებული HTML ფაილის ინსტანსზე განთვსება და NGINX სერვისი დარესტარტება
...
#სქრინები იხილეთ გიტჰაბის პროექტში.
